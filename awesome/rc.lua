...
clientkeys = awful.util.table.join(
    ...
    awful.key({ modkey, "Control", "Shift" }, "h", function (c) awful.client.movetoscreen(c, c.screen + 1) end),
    awful.key({ modkey, "Control", "Shift" }, "l", function (c) awful.client.movetoscreen(c, c.screen - 1) end),
