...
-- note: default config: /etc/xdg/awesome/rc.lua
...
globalkeys = gears.table.join(
    ...
    awful.key({ modkey, "Shift"   }, "Up",    function () awful.spawn("amixer -q sset Master 2%+", false) end,
              {description = "volume up", group = "volume"}),
    awful.key({ modkey, "Shift"   }, "Down",  function () awful.spawn("amixer -q sset Master 2%-", false) end,
